...
SELECT '2024-03-10', '15:00',
    (SELECT location_id FROM auction_house.Location WHERE address = '23 Main St' AND city = 'New York'),
    (SELECT employee_id FROM auction_house.Employee WHERE name = 'Alice Gray')
WHERE NOT EXISTS (
    SELECT 1 FROM auction_house.Auction
    WHERE date = '2024-03-10' AND time = '15:00'
      AND location_id = (SELECT location_id FROM auction_house.Location WHERE address
