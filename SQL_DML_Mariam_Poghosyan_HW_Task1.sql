...
SELECT 
    ...
    to_tsvector('english', '')  -- Convert empty string to tsvector
UNION ALL
SELECT 
    'Fast and Furious', 
...
SELECT 
    ...
    96, 
    16.99, 
    'PG'::mpaa_rating,  -- Explicit cast to mpaa_rating
    NOW(), 
...
-- Insert into film_actor linking actors and films dynamically with case-insensitive matching
